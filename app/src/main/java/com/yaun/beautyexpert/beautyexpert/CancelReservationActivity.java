    ...
    public void display(int ID){
        ...
        if(!c.isAfterLast()){
            ...
            do{
                ...
                count++;
                final TextView uid = new TextView((getApplication()));
                uid.setText("" + c.getString(c.getColumnIndex("userid")));
                ...
                firstName.setPadding(10,30,15,20);
                ...
                lastName.setPadding(10,30,15,20);
